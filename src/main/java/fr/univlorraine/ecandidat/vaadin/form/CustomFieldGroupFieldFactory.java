...
public class CustomFieldGroupFieldFactory extends DefaultFieldGroupFieldFactory{
	...
	public <T extends Field> T createField(Class<?> dataType, Class<T> fieldType) {
		...
		/*La valeur est i18n*/
			...
			return fieldType.cast(new I18nField(tableRefController.getLangueDefault(),tableRefController.getLangueEnService(),
		...
		/*La valeur est un type d'avis*/
			...
			return fieldType.cast(new RequiredComboBox<TypeAvis>(tableRefController.getListeTypeAvis(),TypeAvis.class));
		}
		...
		/*La valeur est un type de diplome*/
			...
			return fieldType.cast(new RequiredComboBox<SiScolTypDiplome>(tableRefController.getListeTypDiplome(),SiScolTypDiplome.class));
		}
		/*La valeur est un type de traitement*/
		else if (dataType==TypeTraitement.class){
			return fieldType.cast(new ComboBoxTypeTraitement(tableRefController.getListeTypeTraitement()));
		}
		/*La valeur est un CGE*/
		else if (dataType==SiScolCentreGestion.class){
			return fieldType.cast(new RequiredComboBox<SiScolCentreGestion>(tableRefController.getListeCentreGestion(),SiScolCentreGestion.class));
		}
		/*La valeur est un type de traitement*/
		...
		/*La valeur est un type de statut de dossier*/
			...
			return fieldType.cast(new RequiredComboBox<TypeStatut>(tableRefController.getListeTypeStatut(),TypeStatut.class));
		}
