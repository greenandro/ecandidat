...
public class CandidatCursusInterneView extends CandidatViewTemplate implements View{
	...
	public void init() {
		...
		Label labelIndicatif = new Label(applicationContext.getMessage("cursusinterne.indication", new Object[]{applicationContext.getMessage("universite.title", null, UI.getCurrent().getLocale())}, UI.getCurrent().getLocale()), ContentMode.HTML);
		addGenericComponent(labelIndicatif);
