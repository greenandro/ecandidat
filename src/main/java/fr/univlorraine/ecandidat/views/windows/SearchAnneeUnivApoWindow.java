...
public class SearchAnneeUnivApoWindow extends Window {
	...
	public SearchAnneeUnivApoWindow() {
		...
		List<SiScolAnneeUni> listeAnneeUni = campagneController.getAnneeUnis();
		...
		btnValider = new Button(applicationContext.getMessage("btnAdd", null, UI.getCurrent().getLocale()), FontAwesome.SAVE);
