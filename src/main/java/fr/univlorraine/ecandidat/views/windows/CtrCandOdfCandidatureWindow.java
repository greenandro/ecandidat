...
public class CtrCandOdfCandidatureWindow extends Window {
	...
	public CtrCandOdfCandidatureWindow(String message) {
		...
		optionGroupAction.setItemCaptionPropertyId(SimpleTablePresentation.champsTitle);
		...
		Button btnNon = new Button(applicationContext.getMessage("confirmWindow.btnNon", null, UI.getCurrent().getLocale()),FontAwesome.TIMES);
		...
		Button btnOui = new Button(applicationContext.getMessage("confirmWindow.btnOui", null, UI.getCurrent().getLocale()),FontAwesome.CHECK);
