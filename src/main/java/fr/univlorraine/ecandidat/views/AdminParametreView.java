...
public class AdminParametreView extends VerticalLayout implements View, EntityPushListener<Parametre>{
	...
	/* Composants */
	private Button btnEditParam = new Button(FontAwesome.PENCIL);
	...
	public void enter(ViewChangeEvent event) {
		...
		container.addAll(parametreController.getParametres().stream().filter(e->!e.getCodParam().equals(NomenclatureUtils.COD_PARAM_IS_MAINTENANCE)).collect(Collectors.toList()));
	}
	...
	public void entityPersisted(Parametre entity) {
		if (!entity.getCodParam().equals(NomenclatureUtils.COD_PARAM_IS_MAINTENANCE)){
