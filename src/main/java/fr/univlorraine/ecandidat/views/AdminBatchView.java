...
public class AdminBatchView extends VerticalLayout implements View, EntityPushListener<Batch> {
	...
	/* Composants */
	private Button btnRefresh = new Button(FontAwesome.REFRESH);
	private Button btnEdit = new Button(FontAwesome.PENCIL);
	private Button btnHisto = new Button(FontAwesome.CLOCK_O);
	private Button btnLaunch = new Button(FontAwesome.ROCKET);
