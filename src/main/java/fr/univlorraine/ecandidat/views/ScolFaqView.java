...
public class ScolFaqView extends VerticalLayout implements View, EntityPushListener<Faq>{
	...
	public void init() {
		...
		Button btnNew = new Button(applicationContext.getMessage("faq.btnNouveau", null, UI.getCurrent().getLocale()), FontAwesome.PLUS);
		...
		/* Table des faqs */
		BeanItemContainer<Faq> container = new BeanItemContainer<Faq>(Faq.class, faqController.getFaq());
