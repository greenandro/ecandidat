...
public class ScolMailView extends VerticalLayout implements View, EntityPushListener<Mail>{
	...
	private void populateMailTypeDecLayout(VerticalLayout layoutMailTypeDec) {
		...
		Button btnNew = new Button(applicationContext.getMessage("mail.btnNouveau", null, UI.getCurrent().getLocale()), FontAwesome.PLUS);
		...
		Button btnEditMailTypeDec = new Button(applicationContext.getMessage("btnEdit", null, UI.getCurrent().getLocale()), FontAwesome.PENCIL);
	...
	private void populateMailModelLayout(VerticalLayout layoutMailModel) {
		...
		Button btnEditMailModel = new Button(applicationContext.getMessage("btnEdit", null, UI.getCurrent().getLocale()), FontAwesome.PENCIL);
