...
public class CandidatInfoPersoView extends CandidatViewTemplate implements View, InfoPersoListener{	
	...
	private Button btnEdit = new Button(FontAwesome.PENCIL);
	private Label noInfoLabel = new Label();
	private Label labelMail = new Label();
	private Button changeContactBtn = new Button(FontAwesome.ENVELOPE_O);
	...
	public void init() {		
		...
		infoPersoTable.addGeneratedColumn(SimpleTablePresentation.champsValue, new Table.ColumnGenerator() {
            /**serialVersionUID**/
		...
		infoPersoTable.setColumnWidth(SimpleTablePresentation.champsTitle, 250);
