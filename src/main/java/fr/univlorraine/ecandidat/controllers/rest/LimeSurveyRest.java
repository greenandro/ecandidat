...
public class LimeSurveyRest {
	 ...
	 * @throws IOException
	 */
	public List<SurveyReponse> exportResponse(Integer idSurvey) throws JsonParseException, JsonMappingException, IOException{
		...
		obj.addParameter("iSurveyID", idSurvey);
		obj.addParameter("sDocumentType", "json");
		obj.addParameter("sLanguageCode", "fr");
