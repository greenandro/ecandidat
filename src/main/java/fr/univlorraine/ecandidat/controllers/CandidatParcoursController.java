...
public class CandidatParcoursController {
	...
	public List<SimpleTablePresentation> getInformationsBac(CandidatBacOuEqu candidatBacOuEqu) {
		...
		if (candidatBacOuEqu.getSiScolPays()!=null && candidatBacOuEqu.getSiScolPays().equals(tableRefController.getPaysFrance())){
	...
	public CandidatBacOuEqu getBacByApogeeData(WSBac bacApogee, Candidat candidat, Boolean needToDeleteDataApogee){
		if (bacApogee!=null){
			...
			if (dpt != null){
				pays = tableRefController.getPaysFrance();
			}
	...
	/** Supprime tout les parcours d'un candidat
	 * @param candidat
	 */
	@Transactional
	public void deleteAllParcours(Candidat candidat){
		candidatBacOuEquRepository.delete(candidat.getCandidatBacOuEqu());		
		candidat.getCandidatCursusInternes().forEach(e->candidatCursusInterneRepository.delete(e));
		candidat.getCandidatCursusPostBacs().forEach(e->candidatCursusPostBacRepository.delete(e));
		candidat.getCandidatCursusPros().forEach(e->candidatCursusProRepository.delete(e));
		candidat.getCandidatStage().forEach(e->candidatStageRepository.delete(e));
		candidat.setCandidatBacOuEqu(null);
		candidat.setCandidatCursusInternes(null);
		candidat.setCandidatCursusPostBacs(null);
		candidat.setCandidatCursusPros(null);
		candidat.setCandidatStage(null);
	}	
}
