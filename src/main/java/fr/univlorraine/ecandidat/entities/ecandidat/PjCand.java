...
public class PjCand implements Serializable {
	...
	@Column(name="user_cre_pj_cand", nullable=false, length=30)
	@Size(max = 30) 
	@NotNull
	private String userCrePjCand;

	@Column(name="user_mod_pj_cand", nullable=false, length=30)
	@Size(max = 30) 
	@NotNull
	private String userModPjCand;
	
	@Column(name="user_mod_statut_pj_cand", length=30)
	@Size(max = 30) 
