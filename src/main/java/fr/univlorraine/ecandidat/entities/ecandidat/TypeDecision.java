...
public class TypeDecision implements Serializable {
	...
	@Column(name="lib_typ_dec", nullable=false, length=100)
	@Size(max = 100) 
	@NotNull
	...
	@Column(name="user_cre_typ_dec", nullable=false, length=30)
	@Size(max = 30) 
	@NotNull
	private String userCreTypDec;

	@Column(name="user_mod_typ_dec", nullable=false, length=30)
	@Size(max = 30) 
	@NotNull
